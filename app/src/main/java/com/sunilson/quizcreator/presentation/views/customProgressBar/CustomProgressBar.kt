...
class CustomProgressBar : FrameLayout {
    ...
    constructor(context: Context, attributeSet: AttributeSet) : super(context, attributeSet) {
        ...
        val a =
            context.theme.obtainStyledAttributes(attributeSet, R.styleable.CustomProgressBar, 0, 0)
    ...
    constructor(context: Context, title: String, value: Float, subTitle: String = "") : super(
        context
    ) {
        inflater.inflate(R.layout.custom_progress_bar, this, true)
        this.title = title
