...
class TutorialFragment : BaseFragment(), OnBackPressedListener {
    ...
    override fun onCreateView(
        ...
        view.slider.slides = listOf(
            ...
            TutorialSlide(
                getString(R.string.tutorial_question_tab),
                R.drawable.tutorial_create_question
            ),
            TutorialSlide(getString(R.string.tutorial_microphone), R.drawable.tutorial_microphone),
            TutorialSlide(
                getString(R.string.tutorial_answer_pool),
                R.drawable.tutorial_add_answers
            ),
            TutorialSlide(
                getString(R.string.tutorial_answer_options),
                R.drawable.tutorial_answer_options
            ),
