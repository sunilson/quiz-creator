...
class StatisticsFragment : BaseFragment() {
    ...
    private val viewModel: StatisticsFragmentViewModel by lifecycleScope.inject()
    ...
    override fun onCreateView(
        ...
        view.reset_statistics.setOnClickListener {
            val dialog = SimpleConfirmDialog.newInstance(
                getString(R.string.reset_statistics),
                getString(R.string.reset_statistics_question)
            )
