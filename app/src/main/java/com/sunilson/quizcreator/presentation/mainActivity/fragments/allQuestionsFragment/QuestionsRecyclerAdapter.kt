...
class QuestionsRecyclerAdapterFactory @Inject constructor(private val context: Context) {
    fun create(onDeleteCallback: (Question) -> Unit, saveQuestionCallback: (Question) -> Unit, editQuestionCallback: (Question) -> Unit, recyclerView: RecyclerView): QuestionsRecyclerAdapter {
        return QuestionsRecyclerAdapter(context, onDeleteCallback, saveQuestionCallback, editQuestionCallback, recyclerView)
    }
}